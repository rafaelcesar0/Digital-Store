      ...
      <div className='flex justify-center p-12 gap-8'>
        ...
        <div className='flex flex-col gap-y-1 ml-12'>
          ...
          <h3 className='text-dark-gray-2 text-2xl'>
            ...
            <s className='ligth-gray-2 text-base'>219,00</s>
          </h3>

          <p className='text-light-gray font-semibold mt-5'>
          ...
          <ProductOptions
            titulo='Tamanho'
            sizeShoeButtons={['38', '39', '40', '41', '42']}
            styleColorsButtons={[
              'bg-primary',
              'bg-primary-2',
              'bg-error',
          ...
          />
          <button className='w-full p-2 bg-warning rounded-xl text-white font-semibold px-12 mt-5'>
            Comprar
          </button>
        </div>
      </div>
